...
public:
  ...
  void M114();  // M114 - Report current target position, max feedrate, and max acceleration.
  ...
  void M428();  // M428 - Set home position to the current raw angle values.  As soon as this executes the robot will believe the joint angles are X0 Y-90 Z0 U0 V0 W0.
  void M500();  // M500 - Save home offsets.
  void M501();  // M501 - Load home offsets.
  void M502();  // M502 - Reset the home offsets to zero.
  void M503();  // M503 - Report the home offsets.
  
  void D17();  // D17 - Report adjusted sensor values.
  void D18();  // D18 - Copy sensor values to motor step positions.  Deprecated?
  void D19();  // D19 [Pb] - Set and report continuous D17 reporting.
  void D20();  // D20 - Turn off position error.
  void D21();  // D21 [Pb] - Set and report limit checking.
  void D22();  // D22 - Save all PID values to EEPROM.
  ...
  void G28();  // G28 - Go to home position
