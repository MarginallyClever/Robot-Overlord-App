...
/*/
  motors[0].setPID(0.0, 0.0, 0.0);
  motors[1].setPID(0.0, 0.0, 0.0);
  motors[2].setPID(0.0, 0.0, 0.0);
  motors[3].setPID(0.0, 0.0, 0.0);
  motors[4].setPID(0.0, 0.0, 0.0);
  motors[5].setPID(0.0, 0.0, 0.0);
//*/
  //clockISRProfile();
