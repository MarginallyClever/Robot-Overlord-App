...
public class Arm3RobotControlPanel extends JPanel implements ActionListener, ChangeListener {
	/**
	 * Serial version UID
	 */
	...
	private Arm3Robot robotArm=null;
	...
	public Arm3RobotControlPanel(Arm3Robot arm) {
		super();
