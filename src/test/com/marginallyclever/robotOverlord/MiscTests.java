...
public class MiscTests {
	...
	public void plotXZ() {
		...
		// link3 does not bend
		RobotArmBone link4 = model.getBone(4);  double bottom4 = link4.getAngleMin();//double top4 = link4.getRangeMax();  double mid4 = (top4+bottom4)/2;  
		...
		RobotArmBone link6 = model.getBone(6);  double bottom6 = link6.getAngleMin();//double top6 = link6.getRangeMax();  double mid6 = (top6+bottom6)/2;  
	...
	public void plotXY() {
		...
		// Find the min/max range for each joint
		RobotArmBone link0 = model.getBone(0);  double bottom0 = link0.getAngleMin();  double top0 = link0.getAngleMax();//double mid0 = (top0+bottom0)/2;
		RobotArmBone link1 = model.getBone(1);/*double bottom1 = link1.getThetaMin();*/double top1 = link1.getAngleMax();//double mid1 = (top1+bottom1)/2;
		RobotArmBone link2 = model.getBone(2);  double bottom2 = link2.getAngleMin();  double top2 = link2.getAngleMax();//double mid2 = (top2+bottom2)/2;
		// link3 does not bend
		...
		RobotArmBone link5 = model.getBone(5);  double bottom5 = link5.getAngleMin();  double top5 = link5.getAngleMax();  double mid5 = (top5+bottom5)/2;  
		RobotArmBone link6 = model.getBone(6);  double bottom6 = link6.getAngleMin();  double top6 = link6.getAngleMax();  double mid6 = (top6+bottom6)/2;  
