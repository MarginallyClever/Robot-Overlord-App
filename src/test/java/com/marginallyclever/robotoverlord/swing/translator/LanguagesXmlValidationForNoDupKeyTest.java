...
public class LanguagesXmlValidationForNoDupKeyTest {
	...
	public final static String resourceStringForXmlShemaFile = "/com/marginallyclever/robotoverlord/swing/translator/language_no_dup_key.xsd";
...
//	//URL schemaFile = new File("src/test/resources/translator/language_no_dup_key.xsd").toURI().toURL();
		URL schemaFile = this.getClass().getResource(resourceStringForXmlShemaFile);
		...
		if (!xmlFilesWithValidationDefect.isEmpty()) {
			logger.info("invalide with " + resourceStringForXmlShemaFile + " :");
		...
		assertEquals(0, xmlFilesWithValidationDefect.size(), "Some language xml file do not validate with " + resourceStringForXmlShemaFile + "\n" + sb.toString() + ", see previous logs for details");
	}
	...
	public void verifyThatValidationWorks_notvalide() throws IOException {
		...
		String myTestFileWithWithDupKeyInRessources = "/com/marginallyclever/robotoverlord/swing/translator/english_with_dup_key.xml";
	...
	public void verifyThatValidationWorks_valide() throws IOException {
		...
		String myTestFileWithNoDupKeyInRessources = "/com/marginallyclever/robotoverlord/swing/translator/english_with_no_dup_key.xml";
