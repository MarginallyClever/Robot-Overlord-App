...
public class ThorToolGripperControlPanel extends JPanel implements ActionListener, ChangeListener {
	/**
	 * 
	 */
	...
	public ThorToolGripperControlPanel(RobotOverlord gui,ThorToolGripper tool) {
		super();
