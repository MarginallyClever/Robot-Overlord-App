 ...
 *
 */
public class ThorToolGripper extends ThorTool {
	/**
	 * 
	 */
	...
	protected ThorToolGripperControlPanel armToolGripperControlPanel=null;
	...
	public ArrayList<JPanel> getContextPanel(RobotOverlord gui) {
		...
		armToolGripperControlPanel = new ThorToolGripperControlPanel(gui,this);
