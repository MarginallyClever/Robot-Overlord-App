...
import com.marginallyclever.robotOverlord.commands.CommandSelectString;

public class ActionSelectString extends JPanel implements DocumentListener {
	/**
	 * 
	 */
	...
	public ActionSelectString(RobotOverlord ro,String labelName,String defaultValue) {
		super();
		this.ro = ro;
