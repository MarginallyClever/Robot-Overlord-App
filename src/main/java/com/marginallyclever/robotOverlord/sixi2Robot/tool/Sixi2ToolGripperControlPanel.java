...
public class Sixi2ToolGripperControlPanel extends JPanel implements ActionListener, ChangeListener {
	/**
	 * 
	 */
	...
	public Sixi2ToolGripperControlPanel(RobotOverlord gui,Sixi2ToolGripper tool) {
		super();
