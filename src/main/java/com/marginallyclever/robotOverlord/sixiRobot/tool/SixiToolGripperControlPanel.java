...
public class SixiToolGripperControlPanel extends JPanel implements ActionListener, ChangeListener {
	/**
	 * 
	 */
	...
	public SixiToolGripperControlPanel(RobotOverlord gui,SixiToolGripper tool) {
		super();
