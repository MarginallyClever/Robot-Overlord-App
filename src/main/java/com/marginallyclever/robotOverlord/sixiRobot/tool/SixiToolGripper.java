 ...
 *
 */
public class SixiToolGripper extends SixiTool {
	/**
	 * 
	 */
	...
	protected SixiToolGripperControlPanel armToolGripperControlPanel=null;
	...
	public ArrayList<JPanel> getContextPanel(RobotOverlord gui) {
		...
		armToolGripperControlPanel = new SixiToolGripperControlPanel(gui,this);
