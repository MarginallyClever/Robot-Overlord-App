package com.marginallyclever.robotOverlord.entity.scene.robots.rotaryStewartPlatform;
...
public class RotaryStewartPlatform extends RobotEntity {
	...
	protected transient Mesh modelBicep;
	...
	public RotaryStewartPlatform() {
		...
		try {
			modelTop = Mesh.createModelFromFilename("/StewartPlatform.zip:top.STL");
			modelBicep = Mesh.createModelFromFilename("/StewartPlatform.zip:arm.STL");
			modelBase = Mesh.createModelFromFilename("/StewartPlatform.zip:base.STL");
