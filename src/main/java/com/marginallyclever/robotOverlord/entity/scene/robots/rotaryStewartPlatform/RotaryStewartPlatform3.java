...
public class RotaryStewartPlatform3 extends RotaryStewartPlatform {
	...
	protected transient Mesh modelForearm;
	protected RotaryStewartPlatform3Dimensions dimensions;
 	...
 	public RotaryStewartPlatform3() {
		...
		try {
			modelTop = Mesh.createModelFromFilename("/StewartPlatform3.zip:top.stl");
			modelBicep = Mesh.createModelFromFilename("/StewartPlatform3.zip:bicep.stl");
			modelBase = Mesh.createModelFromFilename("/StewartPlatform3.zip:base.stl");
			modelForearm = Mesh.createModelFromFilename("/StewartPlatform3.zip:forearm.stl");
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
