package com.marginallyclever.robotOverlord.uiElements.log;
...
public class LogPanel extends JPanel implements LogListener, ActionListener, KeyListener {
	...
	transient private HTMLEditorKit kit;
	transient private HTMLDocument doc;

	// command line
	transient private JPanel textInputArea;
	transient private JTextField commandLineText;
