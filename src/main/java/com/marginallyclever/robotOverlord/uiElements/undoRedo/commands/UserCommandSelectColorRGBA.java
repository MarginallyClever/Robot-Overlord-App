...
import com.marginallyclever.robotOverlord.uiElements.undoRedo.actions.UndoableActionSelectColorRGBA;
 ...
 *
 */
public class UserCommandSelectColorRGBA extends JPanel implements DocumentListener, Observer {
	/**
	 * 
	 */
	...
	public UserCommandSelectColorRGBA(RobotOverlord ro,ColorEntity e) {
		super();
		this.ro = ro;
		this.e = e;
		...
		//values.setBorder(new LineBorder(Color.GREEN));
	...
	public void changedUpdate(DocumentEvent arg0) {
		...
		if(sum>1e-3) {
			ro.undoableEditHappened(new UndoableEditEvent(this,new UndoableActionSelectColorRGBA(e,newValues) ) );
		}
	}
