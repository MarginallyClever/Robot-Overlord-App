...
import com.marginallyclever.robotOverlord.uiElements.undoRedo.actions.UndoableActionSelectInt;
 ...
 *
 */
public class UserCommandSelectInt extends JPanel implements DocumentListener, Observer {
	/**
	 * 
	 */
	...
	public UserCommandSelectInt(RobotOverlord ro,IntEntity e) {
		super();
		this.ro = ro;
		this.e = e;
	...
	public void changedUpdate(DocumentEvent arg0) {
		...
		if(newNumber != e.get()) {
			ro.undoableEditHappened(new UndoableEditEvent(this,new UndoableActionSelectInt(e, newNumber) ) );
		}
	}
