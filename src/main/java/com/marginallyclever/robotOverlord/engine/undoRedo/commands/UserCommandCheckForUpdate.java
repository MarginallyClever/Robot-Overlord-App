...
/**
 * Checks online for a new version of Robot Overlord. This action is not an undoable action.
 * @author Dan Royer
 *
 */
public class UserCommandCheckForUpdate extends JMenuItem implements ActionListener {
	/**
	 * 
	 */
