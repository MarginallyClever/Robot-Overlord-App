 ...
 *
 */
public class PTTPTPToolGripper extends PTTPTPTool {
	/**
	 * 
	 */
	...
	protected PTTPTPToolGripperControlPanel armToolGripperControlPanel=null;
	...
	public ArrayList<JPanel> getContextPanel(RobotOverlord gui) {
		...
		armToolGripperControlPanel = new PTTPTPToolGripperControlPanel(gui,this);
