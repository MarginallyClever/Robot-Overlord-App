...
public class PTTPTPToolGripperControlPanel extends JPanel implements ActionListener, ChangeListener {
	/**
	 * 
	 */
	...
	public PTTPTPToolGripperControlPanel(RobotOverlord gui,PTTPTPToolGripper tool) {
		super();
