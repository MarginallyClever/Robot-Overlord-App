...
public class RotaryStewartPlatform3ControlPanel extends JPanel implements ActionListener, ChangeListener {
	/**
	 * Serial version UID
	 */
	private static final long serialVersionUID = 257878994328366520L;

	private RotaryStewartPlatform3 robot;
	...
	public RotaryStewartPlatform3ControlPanel(RobotOverlord gui,RotaryStewartPlatform3 robot) {
		super();
	...
	protected void doAbout() {
		...
		box.display(this.getRootPane(), "<html><body>"
				+"<h1>Rotary Stewart Platform 3</h1>"
				+"<p>Created by Dan Royer (dan@marginallyclever.com).</p><br>"
				+"<p>A six axis manipulator.</p><br>"
				+"<p><a href='https://www.marginallyclever.com/product/rotary-stewart-platform-v3/'>Click here for more details</a>.</p>"
