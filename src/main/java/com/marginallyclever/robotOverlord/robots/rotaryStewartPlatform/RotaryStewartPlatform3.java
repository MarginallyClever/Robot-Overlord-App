...
public class RotaryStewartPlatform3 extends RotaryStewartPlatform {
	...
	protected transient Shape modelForearm = new Shape("/StewartPlatform3.zip:forearm.stl");
	protected RotaryStewartPlatform3Dimensions dimensions;
 	...
 	public RotaryStewartPlatform3() {
		...
		modelBase.getMaterial().setDiffuseColor(69.0f/255.0f,115.0f/255.0f,133.0f/255.0f,1);
		modelBicep.getMaterial().setDiffuseColor(2.0f/255.0f,39.0f/255.0f,53.0f/255.0f,1);
		modelForearm.getMaterial().setDiffuseColor(39.0f/255.0f,88.0f/255.0f,107.0f/255.0f,1);
		modelTop.getMaterial().setDiffuseColor(16.0f/255.0f,62.0f/255.0f,80.0f/255.0f,1);

		try {
			modelTop = new Shape("/StewartPlatform3.zip:top.stl");
			modelBicep = new Shape("/StewartPlatform3.zip:bicep.stl");
			modelBase = new Shape("/StewartPlatform3.zip:base.stl");
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
