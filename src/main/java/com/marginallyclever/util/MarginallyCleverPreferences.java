 ...
 */
@Deprecated public class MarginallyCleverPreferences extends AbstractPreferences implements Ancestryable {
    ...
    private final Map<String, Preferences> children = new TreeMap<>();
