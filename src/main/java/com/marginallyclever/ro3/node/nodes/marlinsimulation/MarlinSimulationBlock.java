...
public class MarlinSimulationBlock {
	...
	public MarlinCoordinate start = new MarlinCoordinate();
	public MarlinCoordinate end = new MarlinCoordinate();
	public MarlinCoordinate delta = new MarlinCoordinate();
	public MarlinCoordinate normal = new MarlinCoordinate();
	...
	public MarlinSimulationBlock(final MarlinCoordinate endPose,final MarlinCoordinate deltaPose) {
		end.set(endPose);
		delta.set(deltaPose);
