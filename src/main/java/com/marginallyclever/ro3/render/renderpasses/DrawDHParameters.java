...
public class DrawDHParameters implements RenderPass {
    ...
    public void draw(ShaderProgram shader) {
        ...
        if(myShader==null) {
            try {
                myShader = new ShaderProgram(gl3,
        ...
        while(!toScan.isEmpty()) {
            ...
            if(node instanceof DHParameter parameter) {
                ...
                Matrix4d w = (parentPose==null)
                    ...
                    : parentPose.getWorld();
                w.transpose();
                myShader.setMatrix4d(gl3,"modelMatrix",w);
                myShader.set1f(gl3,"d",(float)parameter.getD());
                myShader.set1f(gl3,"theta",(float)parameter.getTheta());
                myShader.set1f(gl3,"r",(float)parameter.getR());
