...
public class LoadURDF {
    private static final Logger logger = LoggerFactory.getLogger(LoadURDF.class);
    ...
    public Node createFromXML(BufferedInputStream bis) {
        try {
     ...
     */
    private List<Pose> parseLinks(Document doc, Node root) {
    ...
    private void parseLinkElements(org.w3c.dom.Node xmlLink, Node linkNode) {
    ...
    private void parseInertia(org.w3c.dom.Node xmlLink, Node linkNode) {
        // TODO implement me
        logger.debug("parseInertia not implemented yet.");
    }

    private org.w3c.dom.Node findChildByName(org.w3c.dom.Node parent, String name) {
    ...
    private void parseAllVisuals(org.w3c.dom.Node xmlLink, Node linkNode) {
     ...
     */
    private void parseVisual(org.w3c.dom.Node visual, Node linkNode) {
    ...
    private void adjustOrigin(org.w3c.dom.Node xmlNode, Pose pose) {
     ...
     */
    private Material parseMaterial(org.w3c.dom.Node visual) {
     ...
     */
    private MeshInstance parseGeometry(org.w3c.dom.Node visual) {
     ...
     */
    private void parseJoints(Document doc, Node root, List<Pose> links) {
     ...
     */
    private void parseJointLimits(org.w3c.dom.Node xmlJoint, HingeJoint j) {
     ...
     */
    private List<Motor> sortMotorsByHierarchy(List<Motor> motors,Node root) {
     ...
     */
    private Pose findLinkPoseWithName(List<Pose> links, String name) {
        for(Pose p : links) {
