...
public class DemoODEPhysics implements Demo {
	...
	public void execute(Scene scene) {
		...
		scene.addEntityToParent(light0,camera.getEntity());
		...
		ramp.setRotation(R);
		scene.addEntityToParent(createEntity(new ODEPhysicsComponent(ramp)),scene.getRoot());
		scene.addEntityToParent(createEntity(new ODEPhysicsComponent(ground)),scene.getRoot());
		...
		scene.addEntityToParent(createEntity(new ODEPhysicsComponent(box)),scene.getRoot());
		...
		for (i=0; i<sphere.length; i++) {
			...
			scene.addEntityToParent(createEntity(new ODEPhysicsComponent(sphere[i])),scene.getRoot());
		}
