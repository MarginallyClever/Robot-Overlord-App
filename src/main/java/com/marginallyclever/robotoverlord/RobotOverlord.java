...
import com.marginallyclever.robotoverlord.renderpanel.OpenGLRenderPanelBasic;
...
public class RobotOverlord {
	...
	public RobotOverlord() {
		...
		renderPanel = new OpenGLRenderPanelBasic(project.getEntityManager(), this::update);
