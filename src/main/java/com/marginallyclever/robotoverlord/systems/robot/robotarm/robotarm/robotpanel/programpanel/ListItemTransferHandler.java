package com.marginallyclever.robotoverlord.systems.robot.robotarm.robotarm.robotpanel.programpanel;
  ...
  public boolean importData(TransferSupport info) {
    ...
    try {
      ...
      for (int i = 0; i < values.length; i++) {
          if(values[i] instanceof ProgramEvent) {
        	  int idx = index++;
        	  listModel.add(idx, (ProgramEvent)values[i]);
